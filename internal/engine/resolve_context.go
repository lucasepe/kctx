...
func (e *Engine) ResolveContext(ctx context.Context, req ResolveContextRequest) (*ResolveContextResponse, error) {
	...
	if resolved.GVK == corev1.SchemeGroupVersion.WithKind("Pod") {
		...
		return &ResolveContextResponse{SchemaVersion: model.SchemaVersion, Kind: "ResourceContext", Resolved: resolved, Pod: pod}, nil
	}
	...
	return &ResolveContextResponse{SchemaVersion: model.SchemaVersion, Kind: "ResourceContext", Resolved: resolved, Resource: resource}, nil
}

...
func (e *TypedEngine) ResolvePodContext(ctx context.Context, req ResolvePodContextRequest) (*ResolvePodContextResponse, error) {
	...
	resp := &ResolvePodContextResponse{
	...
	normalizePodContextSlices(resp)
	return resp, nil
}

func normalizePodContextSlices(resp *ResolvePodContextResponse) {
	if resp.Owners == nil {
		resp.Owners = []model.Entity{}
	}
	if resp.Services == nil {
		resp.Services = []model.Entity{}
	}
	if resp.Volumes == nil {
		resp.Volumes = []model.VolumeRef{}
	}
	if resp.Events == nil {
